...
export function tweenAnimation1(sphere1, sphere2, sphere3) {
  ...
  tween1 = new TWEEN.Tween(sphere1.material).to({ opacity: 1 }, 1000).easing(TWEEN.Easing.Quadratic.In);

  sphere2.visible = true;
  tween2 = new TWEEN.Tween(sphere2.material).to({ opacity: 1 }, 1000).easing(TWEEN.Easing.Quadratic.In);

  sphere3.visible = true;
  tween3 = new TWEEN.Tween(sphere3.material).to({ opacity: 1 }, 1000).easing(TWEEN.Easing.Quadratic.In);
